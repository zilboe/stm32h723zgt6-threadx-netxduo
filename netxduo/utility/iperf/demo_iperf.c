...
UINT    status;
    ...
    status = nx_ip_create(&ip_0, "NetX IP Instance 0", IP_ADDRESS(192, 168, 3, 100), 0xFFFFFF00UL, &pool_0, nx_stm32_eth_driver,
                          pointer, 2048, 1);
    ...
    if (status)
		...
		ULONG gateway_ip = IP_ADDRESS(192, 168, 3, 100);
							
		gateway_ip = (gateway_ip & 0xFFFFFF00UL) | 0x01;
